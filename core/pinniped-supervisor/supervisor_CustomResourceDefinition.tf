resource "kubectl_manifest" "CustomResourceDefinition_oidcidentityproviders.idp.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
...
resource "kubectl_manifest" "CustomResourceDefinition_oidcclients.config.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
...
resource "kubectl_manifest" "CustomResourceDefinition_activedirectoryidentityproviders.idp.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
...
resource "kubectl_manifest" "CustomResourceDefinition_federationdomains.config.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
...
resource "kubectl_manifest" "CustomResourceDefinition_ldapidentityproviders.idp.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
...
resource "kubectl_manifest" "CustomResourceDefinition_githubidentityproviders.idp.supervisor.pinniped.dev" {
  yaml_body  = <<-EOF
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
